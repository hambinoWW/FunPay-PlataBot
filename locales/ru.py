...
cmd_use_account = "переключить аккаунт FunPay"
cmd_enable_account = "включить аккаунт FunPay"
cmd_disable_account = "отключить аккаунт FunPay"
cmd_remove_account = "удалить аккаунт FunPay"
cmd_account_health = "состояние аккаунтов PLATA"
cmd_stats_all = "общая аналитика всех аккаунтов"
cmd_update_account_key = "обновить токен аккаунта"
cmd_rename_account = "переименовать аккаунт"
