...
cmd_use_account = "switch FunPay account"
cmd_enable_account = "enable FunPay account"
cmd_disable_account = "disable FunPay account"
cmd_remove_account = "remove FunPay account"
cmd_account_health = "PLATA account health"
cmd_stats_all = "analytics for all accounts"
cmd_update_account_key = "update account token"
cmd_rename_account = "rename account"
