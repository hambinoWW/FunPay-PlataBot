...
instance_id: int - ID запуска PLATA.
"""
...
INSTALL_PLUGIN_DEPS = "74"
"""
Callback для установки недостающих Python-библиотек плагина.
Использование: CBT.INSTALL_PLUGIN_DEPS:ключ

ключ: str - UUID плагина или file:<имя файла> для незагруженных плагинов.
"""
