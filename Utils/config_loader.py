...
from Utils.plata_tools import hash_password, build_proxy
...
def load_auto_delivery_config(config_path: str, products_directory: str = "storage/products"):
    """
    ...
    for lot_title in config.sections():
        ...
        products_path = os.path.join(products_directory, products_file_name)
        if not os.path.exists(products_path):
            raise ConfigParseError(config_path, lot_title,
                                   ProductsFileNotFoundError(products_path))
